<script>
  import ThumbnailImg from "./assets/doctor.jpg?enhanced&format=webp"

  import Button from "$ui-kit/Button/Button.svelte"
  import Like   from "$ui-kit/icons/Like.svelte"
</script>

<div class="wrapper favorite_doctor_card">
  ...
  <div class="bottom_info_container">
    ...
    <div class="cost_container">
      <span class="cost_title">Цена приема врача:</span>
      <div class="cost">
        <div class="old">2 000₽</div>
        <div class="current">1 600₽</div>
      </div>
    </div>
  </div>
</div>
