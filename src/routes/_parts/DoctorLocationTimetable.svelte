...
<div class="timetable-container">
    ...
    <div class="address">
        ...
        <p class="body-text-2"><Address type="primary"/>г Москва, ул Миклухо-Маклая, д 43</p>
        <p class="body-text-2"><Metro type="primary"/><span>Беляево (400 м)</span></p>
        <p class="body-text-2"><Phone type="primary"/>+7 930 999-17-56</p>
    ...
    <div class="sign-up">
        <div class="link-font-2">Записалось 22 человека</div>
