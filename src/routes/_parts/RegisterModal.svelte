<script lang="ts">
  ...
  import {GOOGLE_AUTH_URL, VK_AUTH_URL} from "$api/local-server.js"
  import SmsCodeForm from "./RegisterModalParts/SmsAuthForm.svelte"
...
<Modal bind:isActive>
  <div class="modal" id="enter_account_modal">
    ...
    <div class="register_buttons">
      ...
      <Button onclick={authVK} fullWidth outline>
        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
