<script>
  import ThumbnailImg from "../_assets/clinic.png?enhanced&format=webp"
  import ClinicIconImg from "../_assets/clinic_icon.jpg?enhanced&format=webp"
...
<article class="favorite_clinic_card">
