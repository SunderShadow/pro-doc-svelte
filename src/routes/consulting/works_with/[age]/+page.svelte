...
<section class="page-container">
  ...
  <div id="consulting_preview">
    <Preview title="Онлайн-консультации врача" image={PreviewImg.img.src} imageMobile={PreviewImgMobile.img.src} withGradient>
      <p class="body-text-2">
        Онлайн-консультации врача - это возможность получить медицинскую консультацию удаленно, используя интернет-технологии. Врачи могут проводить консультации через видеозвонки, чаты или электронную почту.
      </p>
    </Preview>
  </div>
</section>
...
<section class="page-container page-section">
  ...
  <div class="main_container">
    ...
    <main>
      <div class="switcher">
        <a class:active={age === 'adults'} href="/consulting/works_with/adults" data-sveltekit-noscroll>Взрослый врач</a>
        <a class:active={age === 'children'} href="/consulting/works_with/children" data-sveltekit-noscroll>Детский врач</a>
      </div>
